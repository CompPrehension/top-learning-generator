...
config = imgkit.config(wkhtmltoimage='c:/D/Work/4labs/wkhtmltopdf/bin/wkhtmltoimage.exe')   # to install: visit https://wkhtmltopdf.org/

options = {
    # 'format': 'png',  # 36 time bigger file than jpg
    # 'format': 'jpg',
    'encoding': "UTF-8",
    'log-level': "none",
}
...
def html_2_jpg_batch(dir_src=r'c:\Temp2\cntrflowoutput_v6_html', dest_dir=r'c:\Temp2\cntrflowoutput_v6_jpg', ext_pattern='*.html', limit=0, crop=True):
